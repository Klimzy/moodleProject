...
Это довольно старая легаси платформа, а создание тестов для него то еще мучение. Их нужно не только придумать, но и оформить в TXT-файл по определенному шаблону:
